...
class Qiwi{
    ...
    * @var int
    */
    public $shop_id = $options["qiwi-shopid"];
    ...
    * @var int
    */
    public $rest_id = $options["qiwi-apiid"];
    ...
    * @var string
    */
    public $rest_pass = $options["qiwi-apipassword"];
    ...
    */
    ...
    public $currency = $options["qiwi-currency"];
    ...
    * @var string
    */
    public $prv_name = $options["qiwi-nameprovider"];
